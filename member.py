...
bot_token = '6384089824:AAEq7oWZJyg6SdxntbQdW4viHZA3t0RLJfw' 
bot = telebot.TeleBot(bot_token)

allowed_group_id = -875761181
...
def lqm_sms(message):
    ...
    if phone_number in ['113','911','114','115','+8436475811','0336475811']:
